...
| Temporary store root | tippani-s0-s0-github-s0-20260920-215851-c2-iNhIyS |
...
| Store namespace | tippani-s0/s0-github-s0-20260920-215851-c2 |
...
| Cleanup manifest digest | sha256:dbf5705dbaac74f40ea7ed76df31be953fccf9ad2340a570843c856ca957e491 |
| Cleanup expiry | 2026-09-22T15:22:52.353Z |
| Effective target hash | sha256:baa467f84566afbe73ccd9a67ea2a5bb1640b22f1d607cca9d23db965151759b |
...
| Ownership marker | `tippani-s0:s0-github-s0-20260920-215851-c2` |
...
| `S0-COL-002` | absolute | Pass | 8087.760 | accounts=1; clientProcesses=2; clientProcessIds=[5724,5992]; executionMode=independent-os-processes; logicalActors=Synthetic Client 1,Synthetic Client 2; winners=1; staleConflicts=1; noSilentOverwrite=true | [JSON](raw-results.json) |
| `S0-COL-003` | absolute | Pass | 11175.431 | accounts=1; clientProcesses=2; clientProcessIds=[11112,10588]; executionMode=independent-os-processes; staleGeneration=0; reloadedGeneration=1; reconciledGeneration=2; deterministicReconnect=true | [JSON](raw-results.json) |
| `S0-COL-004` | absolute | Pass | 5281.419 | lostResponseDetected=true; noDuplicate=true; reconciledGeneration=1 | [JSON](raw-results.json) |
| `S0-COL-005` | absolute | Pass | 9944.271 | offlinePendingConflicted=true; processRestartRecoveredQueue=true; queueWriterProcessIds=[12920,10004]; queueRestartInspectorProcessId=6036; fifoStoppedAtFirstConflict=true; staleEntryRetained=true; noSilentOverwrite=true; authorityGeneration=2 | [JSON](raw-results.json) |
| `S0-COL-006` | absolute | Pass | 8355.596 | accounts=1; clientProcesses=2; clientProcessIds=[11184,8816]; executionMode=independent-os-processes; changeMechanism=GitHub ref and contents polling; observedGeneration=1 | [JSON](raw-results.json) |
...
| `S0-BCK-004` | absolute | Pass | 9038.760 | winners=1; staleConflicts=1; durableGeneration=2 | [JSON](raw-results.json) |
| `S0-BCK-005` | absolute | Pass | 10966.342 | faultsRejected=4; faultsExercised=["auth-expiry","outage","quota","permission-loss","throttle"]; rejectedFaultGenerationUnchanged=true; throttleRecoveredByBoundedRetry=true; throttleResponses=1; retries=1; retryAfterSeconds=[1]; backoffMs=1000; transferredBytes=102905 | [JSON](raw-results.json) |
...
| `S0-MIG-004` | absolute | Pass | 3481.525 | workspaceIdPreserved=true; generation=1; receipt=true | [JSON](raw-results.json) |
...
| `S0-BKP-003` | absolute | Pass | 5929.143 | recoveredGeneration=1 | [JSON](raw-results.json) |
| `S0-BKP-004` | absolute | Incomplete | 0.296 | github restore cannot establish one atomic authoritative head with the current spike transport. | [JSON](raw-results.json) |
...
| `S0-REC-003` | absolute | Pass | 24560.036 | faultsExercised=["outage","throttle","auth-expiry","quota","permission-loss","lost-response"]; recoveredFaults=["outage","throttle","auth-expiry","quota","permission-loss"]; throttleRecovery={"boundedRetries":1,"retryAfterSeconds":1,"minimumBackoffMs":1000}; lostResponseReconciled=true; blindRetryRejected=true | [JSON](raw-results.json) |
| `S0-REC-004` | absolute | Pass | 12121.094 | discoveredNewerAuthority=true; transientFailureRetained=true; processRestartRecoveredQueue=true; queueWriterProcessId=5800; queueRestartInspectorProcessId=8044; noSilentOverwrite=true | [JSON](raw-results.json) |
...
| `S0-SEC-002` | absolute | Pass | 0.558 | corporateFallbackImpossible=true | [JSON](raw-results.json) |
| `S0-SEC-003` | absolute | Pass | 1.177 | syntheticFixtureAccepted=true; actualDataRejected=true | [JSON](raw-results.json) |
| `S0-SEC-004` | absolute | Pass | 0.574 | configSecretRejected=true; workspaceHasNoSecrets=true | [JSON](raw-results.json) |
| `S0-SEC-005` | absolute | Pass | 0.583 | ownedAuthorized=true; foreignRefused=true | [JSON](raw-results.json) |
| `S0-SEC-006` | absolute | Pass | 99.464 | nonPositiveBudgetsRejected=true; operationLimitEnforced=true; objectLimitEnforced=true; byteLimitEnforced=true; deadlineEnforced=true; abortSignalEnforced=true; providerChildBudget={"metered":true,"childPid":2604,"operationsBefore":303,"operationsAfter":304}; cleanupBudgeted=true; cleanupSharedDeadline=true | [JSON](raw-results.json) |
...
|---|---|---:|---|
| `S0-COL-006` | collaboratorDiscoveryMs | 433.000 | ms |
| `S0-PER-004` | setupMs_small | 5205.022 | ms |
| `S0-PER-004` | warmupMs_small | 1145.211 | ms |
| `S0-PER-004` | remoteCasMinMs_small | 1013.850 | ms |
| `S0-PER-004` | remoteCasP50Ms_small | 1084.069 | ms |
| `S0-PER-004` | remoteCasP95Ms_small | 1560.151 | ms |
| `S0-PER-004` | remoteCasMaxMs_small | 1560.151 | ms |
| `S0-PER-004` | remoteCasMeanMs_small | 1163.559 | ms |
| `S0-PER-004` | remoteCasStdDevMs_small | 185.347 | ms |
| `S0-PER-004` | collaboratorDiscoveryMinMs_small | 427.626 | ms |
| `S0-PER-004` | collaboratorDiscoveryP50Ms_small | 451.144 | ms |
| `S0-PER-004` | collaboratorDiscoveryP95Ms_small | 577.240 | ms |
| `S0-PER-004` | collaboratorDiscoveryMaxMs_small | 577.240 | ms |
| `S0-PER-004` | collaboratorDiscoveryMeanMs_small | 476.410 | ms |
| `S0-PER-004` | collaboratorDiscoveryStdDevMs_small | 50.438 | ms |
| `S0-PER-004` | cleanupMs_small | 0.025 | ms |
| `S0-PER-004` | setupMs_medium | 5101.323 | ms |
| `S0-PER-004` | warmupMs_medium | 1191.144 | ms |
| `S0-PER-004` | remoteCasMinMs_medium | 1076.246 | ms |
| `S0-PER-004` | remoteCasP50Ms_medium | 1189.526 | ms |
| `S0-PER-004` | remoteCasP95Ms_medium | 2187.855 | ms |
| `S0-PER-004` | remoteCasMaxMs_medium | 2187.855 | ms |
| `S0-PER-004` | remoteCasMeanMs_medium | 1453.970 | ms |
| `S0-PER-004` | remoteCasStdDevMs_medium | 435.777 | ms |
| `S0-PER-004` | collaboratorDiscoveryMinMs_medium | 457.387 | ms |
| `S0-PER-004` | collaboratorDiscoveryP50Ms_medium | 498.348 | ms |
| `S0-PER-004` | collaboratorDiscoveryP95Ms_medium | 606.079 | ms |
| `S0-PER-004` | collaboratorDiscoveryMaxMs_medium | 606.079 | ms |
| `S0-PER-004` | collaboratorDiscoveryMeanMs_medium | 517.170 | ms |
| `S0-PER-004` | collaboratorDiscoveryStdDevMs_medium | 54.633 | ms |
| `S0-PER-004` | cleanupMs_medium | 0.006 | ms |
| `S0-PER-004` | setupMs_stress | 5562.321 | ms |
| `S0-PER-004` | warmupMs_stress | 1351.908 | ms |
| `S0-PER-004` | remoteCasMinMs_stress | 1629.655 | ms |
| `S0-PER-004` | remoteCasP50Ms_stress | 1629.655 | ms |
| `S0-PER-004` | remoteCasP95Ms_stress | 1727.545 | ms |
| `S0-PER-004` | remoteCasMaxMs_stress | 1727.545 | ms |
| `S0-PER-004` | remoteCasMeanMs_stress | 1678.600 | ms |
| `S0-PER-004` | remoteCasStdDevMs_stress | 48.945 | ms |
| `S0-PER-004` | collaboratorDiscoveryMinMs_stress | 607.903 | ms |
| `S0-PER-004` | collaboratorDiscoveryP50Ms_stress | 607.903 | ms |
| `S0-PER-004` | collaboratorDiscoveryP95Ms_stress | 662.283 | ms |
| `S0-PER-004` | collaboratorDiscoveryMaxMs_stress | 662.283 | ms |
| `S0-PER-004` | collaboratorDiscoveryMeanMs_stress | 635.093 | ms |
| `S0-PER-004` | collaboratorDiscoveryStdDevMs_stress | 27.190 | ms |
| `S0-PER-004` | cleanupMs_stress | 0.006 | ms |
| `S0-PER-004` | throttleRecoveryLatencyMs | 2542.690 | ms |
...
- [Cleanup manifest](cleanup-manifest.json) — `sha256:dbf5705dbaac74f40ea7ed76df31be953fccf9ad2340a570843c856ca957e491`
