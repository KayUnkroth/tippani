...
| Temporary store root | tippani-s0-s0-ado-s0-20260920-215851-c2-MZWwCd |
...
| Store namespace | tippani-s0/s0-ado-s0-20260920-215851-c2 |
...
| Cleanup manifest digest | sha256:13879e3896c40cb041c8f426b4cf77fae6012230a42b3a4ef43da61f3f1f044a |
| Cleanup expiry | 2026-09-22T15:15:04.696Z |
| Effective target hash | sha256:04c771b1a1df590c98fb9ff330394e25337251a6e66650e32a09ada6596ddf47 |
...
| Ownership marker | `tippani-s0:s0-ado-s0-20260920-215851-c2` |
...
| `S0-COL-002` | absolute | Pass | 3357.580 | accounts=1; clientProcesses=2; clientProcessIds=[10860,12496]; executionMode=independent-os-processes; logicalActors=Synthetic Client 1,Synthetic Client 2; winners=1; staleConflicts=1; noSilentOverwrite=true | [JSON](raw-results.json) |
| `S0-COL-003` | absolute | Pass | 3699.122 | accounts=1; clientProcesses=2; clientProcessIds=[5600,11336]; executionMode=independent-os-processes; staleGeneration=0; reloadedGeneration=1; reconciledGeneration=2; deterministicReconnect=true | [JSON](raw-results.json) |
| `S0-COL-004` | absolute | Pass | 2038.601 | lostResponseDetected=true; noDuplicate=true; reconciledGeneration=1 | [JSON](raw-results.json) |
| `S0-COL-005` | absolute | Pass | 3959.836 | offlinePendingConflicted=true; processRestartRecoveredQueue=true; queueWriterProcessIds=[2096,4832]; queueRestartInspectorProcessId=10084; fifoStoppedAtFirstConflict=true; staleEntryRetained=true; noSilentOverwrite=true; authorityGeneration=2 | [JSON](raw-results.json) |
| `S0-COL-006` | absolute | Pass | 3128.253 | accounts=1; clientProcesses=2; clientProcessIds=[8916,10124]; executionMode=independent-os-processes; changeMechanism=ADO branch/ref and item polling; observedGeneration=1 | [JSON](raw-results.json) |
...
| `S0-BCK-003` | absolute | Pass | 5213.496 | winners=1; staleConflicts=1; durableGeneration=2 | [JSON](raw-results.json) |
...
| `S0-BCK-005` | absolute | Pass | 9160.104 | faultsRejected=4; faultsExercised=["auth-expiry","outage","quota","permission-loss","throttle"]; rejectedFaultGenerationUnchanged=true; throttleRecoveredByBoundedRetry=true; throttleResponses=1; retries=1; retryAfterSeconds=[1]; backoffMs=1000; transferredBytes=92487 | [JSON](raw-results.json) |
...
| `S0-MIG-004` | absolute | Pass | 1493.710 | workspaceIdPreserved=true; generation=1; receipt=true | [JSON](raw-results.json) |
...
| `S0-BKP-003` | absolute | Pass | 3069.770 | recoveredGeneration=1 | [JSON](raw-results.json) |
| `S0-BKP-004` | absolute | Pass | 3971.670 | restoredGeneration=2; oneHead=true | [JSON](raw-results.json) |
...
| `S0-REC-003` | absolute | Pass | 17666.660 | faultsExercised=["outage","throttle","auth-expiry","quota","permission-loss","lost-response"]; recoveredFaults=["outage","throttle","auth-expiry","quota","permission-loss"]; throttleRecovery={"boundedRetries":1,"retryAfterSeconds":1,"minimumBackoffMs":1000}; lostResponseReconciled=true; blindRetryRejected=true | [JSON](raw-results.json) |
| `S0-REC-004` | absolute | Pass | 4318.278 | discoveredNewerAuthority=true; transientFailureRetained=true; processRestartRecoveredQueue=true; queueWriterProcessId=13724; queueRestartInspectorProcessId=8048; noSilentOverwrite=true | [JSON](raw-results.json) |
...
| `S0-SEC-001` | absolute | Pass | 0.731 | providerPreflightRejected=true; errorCount=8 | [JSON](raw-results.json) |
| `S0-SEC-002` | absolute | Pass | 0.579 | corporateFallbackImpossible=true | [JSON](raw-results.json) |
| `S0-SEC-003` | absolute | Pass | 1.227 | syntheticFixtureAccepted=true; actualDataRejected=true | [JSON](raw-results.json) |
| `S0-SEC-004` | absolute | Pass | 0.641 | configSecretRejected=true; workspaceHasNoSecrets=true | [JSON](raw-results.json) |
| `S0-SEC-005` | absolute | Pass | 0.595 | ownedAuthorized=true; foreignRefused=true | [JSON](raw-results.json) |
| `S0-SEC-006` | absolute | Pass | 103.355 | nonPositiveBudgetsRejected=true; operationLimitEnforced=true; objectLimitEnforced=true; byteLimitEnforced=true; deadlineEnforced=true; abortSignalEnforced=true; providerChildBudget={"metered":true,"childPid":13816,"operationsBefore":385,"operationsAfter":386}; cleanupBudgeted=true; cleanupSharedDeadline=true | [JSON](raw-results.json) |
...
|---|---|---:|---|
| `S0-COL-006` | collaboratorDiscoveryMs | 60.000 | ms |
| `S0-PER-004` | setupMs_small | 1307.223 | ms |
| `S0-PER-004` | warmupMs_small | 258.132 | ms |
| `S0-PER-004` | remoteCasMinMs_small | 486.665 | ms |
| `S0-PER-004` | remoteCasP50Ms_small | 524.092 | ms |
| `S0-PER-004` | remoteCasP95Ms_small | 895.266 | ms |
| `S0-PER-004` | remoteCasMaxMs_small | 895.266 | ms |
| `S0-PER-004` | remoteCasMeanMs_small | 608.508 | ms |
| `S0-PER-004` | remoteCasStdDevMs_small | 144.161 | ms |
| `S0-PER-004` | collaboratorDiscoveryMinMs_small | 54.208 | ms |
| `S0-PER-004` | collaboratorDiscoveryP50Ms_small | 78.775 | ms |
| `S0-PER-004` | collaboratorDiscoveryP95Ms_small | 94.902 | ms |
| `S0-PER-004` | collaboratorDiscoveryMaxMs_small | 94.902 | ms |
| `S0-PER-004` | collaboratorDiscoveryMeanMs_small | 74.543 | ms |
| `S0-PER-004` | collaboratorDiscoveryStdDevMs_small | 14.981 | ms |
| `S0-PER-004` | cleanupMs_small | 0.025 | ms |
| `S0-PER-004` | setupMs_medium | 1611.589 | ms |
| `S0-PER-004` | warmupMs_medium | 289.517 | ms |
| `S0-PER-004` | remoteCasMinMs_medium | 582.603 | ms |
| `S0-PER-004` | remoteCasP50Ms_medium | 706.370 | ms |
| `S0-PER-004` | remoteCasP95Ms_medium | 818.202 | ms |
| `S0-PER-004` | remoteCasMaxMs_medium | 818.202 | ms |
| `S0-PER-004` | remoteCasMeanMs_medium | 707.290 | ms |
| `S0-PER-004` | remoteCasStdDevMs_medium | 83.763 | ms |
| `S0-PER-004` | collaboratorDiscoveryMinMs_medium | 94.230 | ms |
| `S0-PER-004` | collaboratorDiscoveryP50Ms_medium | 113.265 | ms |
| `S0-PER-004` | collaboratorDiscoveryP95Ms_medium | 191.130 | ms |
| `S0-PER-004` | collaboratorDiscoveryMaxMs_medium | 191.130 | ms |
| `S0-PER-004` | collaboratorDiscoveryMeanMs_medium | 135.330 | ms |
| `S0-PER-004` | collaboratorDiscoveryStdDevMs_medium | 36.551 | ms |
| `S0-PER-004` | cleanupMs_medium | 0.005 | ms |
| `S0-PER-004` | setupMs_stress | 1788.705 | ms |
| `S0-PER-004` | warmupMs_stress | 564.005 | ms |
| `S0-PER-004` | remoteCasMinMs_stress | 972.875 | ms |
| `S0-PER-004` | remoteCasP50Ms_stress | 972.875 | ms |
| `S0-PER-004` | remoteCasP95Ms_stress | 1013.431 | ms |
| `S0-PER-004` | remoteCasMaxMs_stress | 1013.431 | ms |
| `S0-PER-004` | remoteCasMeanMs_stress | 993.153 | ms |
| `S0-PER-004` | remoteCasStdDevMs_stress | 20.278 | ms |
| `S0-PER-004` | collaboratorDiscoveryMinMs_stress | 95.448 | ms |
| `S0-PER-004` | collaboratorDiscoveryP50Ms_stress | 95.448 | ms |
| `S0-PER-004` | collaboratorDiscoveryP95Ms_stress | 125.902 | ms |
| `S0-PER-004` | collaboratorDiscoveryMaxMs_stress | 125.902 | ms |
| `S0-PER-004` | collaboratorDiscoveryMeanMs_stress | 110.675 | ms |
| `S0-PER-004` | collaboratorDiscoveryStdDevMs_stress | 15.227 | ms |
| `S0-PER-004` | cleanupMs_stress | 0.006 | ms |
| `S0-PER-004` | throttleRecoveryLatencyMs | 1999.602 | ms |
...
- [Cleanup manifest](cleanup-manifest.json) — `sha256:13879e3896c40cb041c8f426b4cf77fae6012230a42b3a4ef43da61f3f1f044a`
